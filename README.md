...
[Cross-platform installer](https://snapcraft.io/polarr/)

This is the recommended way of installing Polarr because it will receive automatic updates and bugfixes. Polarr is only officially supported on Ubuntu 16.04 and 17.10, but it should also run on all Linux distributions with Snap support.
